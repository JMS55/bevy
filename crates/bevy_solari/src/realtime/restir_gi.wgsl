...
#else
    reservoir.radiance = query_world_cache(sample_point.world_position, sample_point.geometric_world_normal, ray.t, view.world_position, WORLD_CACHE_CELL_LIFETIME, rng);
