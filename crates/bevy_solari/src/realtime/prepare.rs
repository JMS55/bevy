...
use bevy_render::{
    ...
    render_resource::{
        Buffer, BufferDescriptor, BufferUsages, FilterMode, Sampler, SamplerDescriptor,
...
pub struct SolariLightingResources {
    ...
    pub previous_color_buffer: TextureView,
...
pub fn prepare_solari_lighting_resources(
    ...
    for query_item in &mut query {
        ...
        let (entity, mut solari_lighting, camera, solari_lighting_resources, resolution_override) =
            query_item;
        #[cfg(all(feature = "dlss", not(feature = "force_disable_dlss")))]
        let (
            entity,
        ...
        let previous_color_buffer = render_device
            .create_texture(&TextureDescriptor {
                label: Some("solari_lighting_previous_color_buffer"),
                size: camera.physical_viewport_size.unwrap().to_extents(),
                mip_level_count: 1,
                sample_count: 1,
                dimension: TextureDimension::D2,
        ...
        let linear_sampler = render_device.create_sampler(&SamplerDescriptor {
            label: Some("solari_lighting_linear_sampler"),
        ...
        #[cfg(all(feature = "dlss", not(feature = "force_disable_dlss")))]
        if has_dlss_rr {
            let diffuse_albedo = render_device
                .create_texture(&TextureDescriptor {
            ...
            let specular_albedo = render_device
                .create_texture(&TextureDescriptor {
            ...
            let normal_roughness = render_device
                .create_texture(&TextureDescriptor {
            ...
            let specular_motion_vectors = render_device
                .create_texture(&TextureDescriptor {
