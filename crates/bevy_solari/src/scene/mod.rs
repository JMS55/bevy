...
use extract::{
    extract_raytracing_environment_light, extract_raytracing_material_assets,
    extract_raytracing_scene_meshes_and_materials, extract_raytracing_scene_structural,
    extract_raytracing_scene_transforms, ExtractedEnvironmentLight, StandardMaterialAssets,
};
use tracing::warn;
...
impl Plugin for RaytracingScenePlugin {
    ...
    fn finish(&self, app: &mut App) {
        ...
        render_app
            .init_resource::<ExtractedEnvironmentLight>()
            ...
            .add_systems(
                ...
                (
                    ...
                    extract_raytracing_environment_light,
                ),
            )
            .add_systems(
                Render,
