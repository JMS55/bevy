...
@group(1) @binding(19) var<storage, read_write> world_cache_good_lights: array<u32, 128u * #{WORLD_CACHE_SIZE}>;
@group(1) @binding(20) var<storage, read_write> world_cache_good_light_weights: array<f32, 128u * #{WORLD_CACHE_SIZE}>;
