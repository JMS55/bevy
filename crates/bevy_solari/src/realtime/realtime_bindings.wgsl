...
@group(1) @binding(21) var<storage, read_write> world_cache_sampling_weights: array<f32, 8u * #{WORLD_CACHE_SIZE}>;
@group(1) @binding(22) var<storage, read_write> world_cache_sampling_counts: array<u32, 8u * #{WORLD_CACHE_SIZE}>;
@group(1) @binding(23) var<storage, read_write> world_cache_a: array<u32, #{WORLD_CACHE_SIZE}>;
@group(1) @binding(24) var<storage, read_write> world_cache_b: array<u32, 1024u>;
@group(1) @binding(25) var<storage, read_write> world_cache_active_cell_indices: array<u32, #{WORLD_CACHE_SIZE}>;
@group(1) @binding(26) var<storage, read_write> world_cache_active_cells_count: u32;
